...
static const char *audio_mute_toggle[] = {"pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle", NULL};
...
static const char *increase_bright[] = {"light", "-A", "10", NULL};
static const char *decrease_bright[] = {"light", "-U", "10", NULL};
...
static const Key keys[] = {
	...
	{ 0,                            XF86XK_AudioMute,  spawn, {.v = audio_mute_toggle }},
	{ 0,                            XF86XK_AudioLowerVolume,  spawn, {.v = audio_down}},
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn, {.v = audio_up}},
	{ 0,                            XF86XK_MonBrightnessUp,   spawn, {.v = increase_bright}},
	{ 0,                            XF86XK_MonBrightnessDown, spawn, {.v = decrease_bright}},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
